...
class GradeDeProdutos extends React.Component{
	constructor(props){
		...
		this.listaDeProdutosFiltrada = this.state.listaDeProdutos
	}
	...
	componentDidMount = () => {
		console.log(this.props.filtroDeCategoria)

	}

	filtrarLista = () => {
		console.log(this.props.filtroDeCategoria)
		if(this.props.filtroDeCategoria !== "Todas as Categorias") {
			this.listaDeProdutosFiltrada = this.state.listaDeProdutos.filter(produto => {
				if(produto.category === this.props.filtroDeCategoria) {
					return true
				}
				return false
			})
	...
	render = () => {
		...
		return(
			<Section>
				{this.listaDeProdutosFiltrada.map(produto => {
